...
const FALLBACK_TASKS = [
  ...
  { id: 'mirror', name: 'Mirror', instruction: 'Swipe the OPPOSITE direction to the arrow. 4 rounds. Your instincts will betray you.', type: 'mirror', config: { rounds: 4, time_per_round: 1800 }, stats: { task_id: 'mirror', attempts: 0, completions: 0, completion_rate: 0 } },
  { id: 'memory_dot', name: 'Ghost Dot', instruction: 'A dot flashes for under a second then vanishes. Tap exactly where it was.', type: 'memory_dot', config: { show_ms: 850, tolerance_px: 18 }, stats: { task_id: 'memory_dot', attempts: 0, completions: 0, completion_rate: 0 } },
  { id: 'simon', name: 'Simon', instruction: '4 colors flash in sequence. Reproduce the exact order. No second chances.', type: 'simon', config: { sequence_length: 4, flash_ms: 420, gap_ms: 160 }, stats: { task_id: 'simon', attempts: 0, completions: 0, completion_rate: 0 } },
  { id: 'count_flash', name: 'Flash Count', instruction: 'A dot flashes multiple times rapidly. Count the exact number and enter it.', type: 'count_flash', config: { flash_ms: 110, gap_ms: 85, min_count: 5, max_count: 13 }, stats: { task_id: 'count_flash', attempts: 0, completions: 0, completion_rate: 0 } },
  { id: 'two_tap', name: '2-Second Gap', instruction: 'Tap once to start the clock. Tap again exactly 2.0 seconds later. No display.', type: 'two_tap', config: { target_ms: 2000, tolerance_ms: 80 }, stats: { task_id: 'two_tap', attempts: 0, completions: 0, completion_rate: 0 } },
  { id: 'number_order', name: 'Find Order', instruction: '7 numbers are scattered. Tap 1 through 7 in order. One number is microscopic.', type: 'number_order', config: { count: 7, tiny_index: -1 }, stats: { task_id: 'number_order', attempts: 0, completions: 0, completion_rate: 0 } },
  { id: 'stroop', name: 'Stroop', instruction: 'Tap the color the word is WRITTEN IN — not the color it names. 4 rounds.', type: 'stroop', config: { rounds: 4 }, stats: { task_id: 'stroop', attempts: 0, completions: 0, completion_rate: 0 } },
  { id: 'silent_beat', name: 'Silent Beat', instruction: 'A pulse beats 3 times then stops. Tap on the 4th beat. Feel the rhythm.', type: 'silent_beat', config: { beat_ms: 620, beats: 3, tolerance: 110 }, stats: { task_id: 'silent_beat', attempts: 0, completions: 0, completion_rate: 0 } }
];
